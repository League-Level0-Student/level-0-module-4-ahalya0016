...
System.out.println(story);
	if (story == 2)	{
	int story1 = JOptionPane.showOptionDialog(null, "Bob walks away but is stopped by ...", "Story", 0, JOptionPane.INFORMATION_MESSAGE, null,
	new String[] { " A police officer", "His friend", "A stranger on the street" }, null);
}
if (story == 1) {
